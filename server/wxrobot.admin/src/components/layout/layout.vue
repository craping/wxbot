    ...
    <div class="layout">
        <Layout>
            <Sider ref="sidebar" class="sidebar" hide-trigger collapsible width="230" :collapsed-width="78" v-model.trim="isCollapsed">
                ...
                <Menu ref="side_menu" :active-name="activeMenuName" :open-names="openMenuName" theme="light" width="230px" :class="menuitemClasses" @on-select="choosedMenu" v-if="!isCollapsed">
                ...
                <Header class="layout-header-bar">
                    <div class="header-wapper">
                        <div class="header-left">
                            ...
                            <span class="header-title">微信机器人后台管理系统</span>
                        </div>
...
export default {
                    ...
                    children: [
                        {
                            title: '公告列表',
                            name: 'notice-list',
                            href: '/notice-management/notice-list',
                            closable: true,
                            showInTags: false,
                            showInMenus: true,
                            choosed: false
                        }, 
                        {
                            title: '发布公告',
                            name: 'notice-add',
                            href: '/notice-management/notice-add',
                            closable: true,
                            showInTags: false,
                            showInMenus: true,
                            choosed: false
    ...
    methods: {
        ...
        quit() {
            this.$http.post("/admin/logout?format=json", {})
                .then(response => {
...
export const closeTag = (name) => {
    vm.closeTag(event, name);
}
export const choosedMenu = (name) => {
    vm.choosedMenu(name);
}
</script>
